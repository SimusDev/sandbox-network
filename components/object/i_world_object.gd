...
func set_in(ref: Object) -> void:
	if owner:
		return
		
	ref.set_meta("I_ObjectInstance", self)
	owner = ref

static func find_in(ref: Node) -> I_ObjectInstance:
	if ref.has_meta("I_ObjectInstance"):
		return ref.get_meta("I_ObjectInstance")
	return null
...
static func deserialize(serialized: Array, ref: Object = null) -> I_ObjectInstance:
